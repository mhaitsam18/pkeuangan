              ...
              <div class="box">
                <div class="box-body">
                  <table id="example" class="display nowrap" style="width:100%">
                    <?php
                    $peng = $this->db->query("SELECT * FROM pengeluaran WHERE user_id='$id' AND year(tanggal)='$tahun' AND month(tanggal)='$bulan' AND day(tanggal)='$tanggal'");
                    $pengt = 0;
                    $r = 0;
                    $rata = 0;
                    ...
                    <tbody>
                      ...
                      <?php endforeach; ?>
                      <tr>
                        <td><b>Laporan Harian Pengeluaran</b></td>
                        <td><b>Rata - Rata Pengeluaran = <?= convRupiah($rata) ?></b></td>
