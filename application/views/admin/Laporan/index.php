                            ...
                            <div class="box-body text-center">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/pemasukanh'); ?>
                                            <div class="row">
                                                <div class="col-sm-4">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/pemasukanb'); ?>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Bulan</label>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/pemasukant'); ?>
                                            <div class="row">
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                            ...
                            <div class="box-body text-center">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/pengh'); ?>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Tanggal</label>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/pengb'); ?>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Bulan</label>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/pengt'); ?>
                                            <div class="row">
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-body text-center">
                                <h1>Laporan Tabungan & Investasi</h1>
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        <div class="card-header" style="background-color: #367fa9;">
                                            <h3 class="card-title">Laporan Harian</h3>
                            ...
                            <div class="box-body text-center">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/huth'); ?>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Tanggal</label>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/hutb'); ?>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Bulan</label>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <?php echo form_open('admin/laporan/hutt'); ?>
                                            <div class="row">
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
