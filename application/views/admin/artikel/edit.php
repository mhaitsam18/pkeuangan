    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box">
          ...
          <form action="<?php echo base_url() . 'admin/artikel/update/' . $item->id; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <fieldset>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" id="inputUserName" value="<?= $item->nama ?>" placeholder="Masukan Nama Artikel" required>
                      </div>
                      <input type="hidden" value="<?= date('d-m-Y'); ?>" name="tanggal">
                      <textarea id="editor" name="detail"><?= $item->detail ?></textarea>
                      <div class="form-group">
                        <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="youtube" id="youtube" placeholder="Ex: https://youtu.be/FM7MFYoylVs" value="<?= (isset($item->youtube)) ? "https://youtu.be/" . $item->youtube : ''; ?>">
